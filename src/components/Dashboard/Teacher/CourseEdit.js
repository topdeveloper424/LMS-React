            ...
            <div className={classes.root}>
                <Grid container>
                    <Grid item xs={12} sm={12} className={classes.headerTitle}>
                        <h3>{this.props.location.state.course.subject}{this.props.location.state.course.name}</h3>
                    </Grid>
                    <Grid item xs={12} sm={12} className={classes.subRoot}>
                        ...
                        <Grid item xs={12} sm={10} className={classes.tabRoot}>
                            ...
                            <Grid className={classes.btnGroup}>
                                <Button className={classes.button} color="facebook">Modify</Button>
                                <Button className={classes.button} color="danger">Delete</Button>
                                <Button onClick={this.props.history.goBack} className={classes.button} color="success">Course Management</Button>
                            </Grid>
                        </Grid>
                    </Grid>
